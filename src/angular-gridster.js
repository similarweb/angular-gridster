        ...
        .factory('GridsterDraggable', ['$document', '$window', 'GridsterTouch',
            function ($document, $window, GridsterTouch) {
                function GridsterDraggable($el, scope, gridster, item, itemOptions) {
                    ...
                    var dragContainer = gridster.draggable.dragContainer ? angular.element(gridster.draggable.dragContainer) : $document;
                    ...
                    function mouseDown(e) {
                        ...
                        grabPosX = e.pageX - $el.offset().left;
                        grabPosY = e.pageY - $el.offset().top;
                        lastMouseX = e.pageX;
                        lastMouseY = e.pageY;
                    ...
                    function drag(event) {
                        ...
                        var scrollTop = dragContainer.scrollTop();
                        if (event.pageY - scrollTop < scrollSensitivity) {
                           // console.debug("scrolling up");
                            dragContainer.scrollTop(scrollTop - scrollSpeed);
                        } else if (dragContainer.height() - event.pageY < scrollSensitivity) {
                           // console.debug("scrolling down");
                            dragContainer.scrollTop(scrollTop + scrollSpeed);
                        }

                        var scrollLeft = dragContainer.scrollLeft();
                        if (event.pageX - scrollLeft < scrollSensitivity) {
                            dragContainer.scrollLeft(scrollLeft - scrollSpeed);
